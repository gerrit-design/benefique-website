...
slug: "dso-benchmarks-imaging-centers-2026-sefl"
metaTitle: "DSO Benchmarks for Imaging Centers (2026) | Benefique"
metaDescription: "Five payer-class DSO benchmarks for SE Florida imaging centers in 2026 — Tier-1, Tier-2, Medicare, PIP, and LOP — with the weighted-DSO math your accountant will not run."
...
Each one collects at a fundamentally different speed, with a fundamentally different yield, and responds to fundamentally different operational levers. Averaging them produces a number that's mathematically valid and operationally meaningless. (We covered this dynamic in detail in [Your DSO Is Lying to You — Why Averages Hide Your Real Cash Flow Problem](/blog/dso-lying-medical-practice-cash-flow); this article extends that frame into payer-class benchmarks and the weighted DSO math.)
...
- Is there a single carrier driving the average up while the rest of the bucket performs?
...
This is the single most important conversation to have with a lender before they discover it themselves. (See: [Radiology Accounts Receivable: How Banks Misread Your Aging Report](/blog/radiology-accounts-receivable-line-of-credit).)
...
- **X-ray** typically collects fastest because it skews Medicare and Tier-1 commercial in straightforward outpatient orders
- **Ultrasound and DEXA** behave similarly to X-ray, with slightly more PIP exposure in injury-driven volume
- **MRI** is the highest-PIP-exposure modality at most SE Florida centers; expect PIP and LOP overrepresentation, dragging modality-level DSO into the 60–90 day range
- **CT** sits between MRI and X-ray, with a higher Medicare share buffering the PIP exposure
- **PET Tracer Scans** collect slowest in the clean-payer buckets, because high-cost imaging triggers more rigorous prior-auth and medical-necessity review at every commercial carrier
...
This is exactly the Two Business Unit Framework we apply inside every [Radiology CFO engagement](/services/radiology). PET Tracer DSO isn't a problem to fix — it's a different business to operate.
...
**1. Decompose your aging report into the five payer buckets — this week.**
You can't manage what you can't see. If your billing company can't produce per-payer-class aging in under 48 hours, that is itself a finding. Run the decomposition in QuickBooks, Excel, or a $200/mo BI tool — the format matters less than the segmentation.

**2. Audit Tier-1 claims aged 45+ days.**
...
**5. Build the weighted DSO calculation into your monthly close.**
One number. Calculated the same way every month. Tracked against the prior month and the prior year. Visible to the operator, the COO, and the board. Aggregate DSO continues to be reported externally — but internally, weighted DSO is the only number that drives operational decisions.
...
A [Strategic Radiology Review](/services/radiology) is a fixed-fee, two-week engagement that produces the per-payer-class aging decomposition, weighted DSO baseline, and prioritized action plan described in this article — alongside Two Business Unit P&L decomposition, per-claim profitability, and a banker-grade Intelligence PDF. Built specifically for multi-center imaging operators who suspect their accountant and billing company cannot answer per-payer profitability questions.
...
**Is Florida PIP being repealed in 2026?**
No. Despite recurring rumors, the Florida no-fault PIP statute remains in force in 2026. Operators planning around a near-term repeal are planning around a fiction. The right strategy is to manage PIP to its own benchmark (75–120 days median), not to expect statutory relief.

**Should I include LOP receivables in my DSO calculation?**
Include them in the calculation, but report them separately and at yield-adjusted value, not face value. LOP receivables behave like contingent legal claims, not commercial A/R. Most imaging centers in SE Florida carry them at gross face value, which inflates apparent A/R, distorts DSO, and creates avoidable surprises in lender diligence.

**How fast can DSO actually be compressed?**
A focused 90-day program targeting Tier-1 audit, PIP reconciliation, and weighted-DSO reporting cadence will typically compress weighted DSO by 5–10 days at a multi-center imaging group, freeing $135K–$275K in cash on a $10M revenue base. The compression is not free — it requires operational discipline that has to survive the program — but the cash is already in the building.
