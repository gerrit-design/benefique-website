...
Warren Buffett has said: ["Does management think the tooth fairy pays for capital expenditures?"](https://www.wallstreetprep.com/knowledge/warren-buffett-ebitda/) Charlie Munger was blunter. He said that every time you see the word EBITDA, [you should substitute "bullshit earnings."](https://finance.yahoo.com/news/charlie-munger-explains-called-popular-earnings-measure-horror-squared-164228068.html)
...
When you apply for a business loan, the lender calculates your DSCR before anything else. The [SBA requires a minimum projected DSCR of 1.15x](https://www.sba7a.loans/sba-7a-loans-small-business-blog/required-dscr/) for 7(a) loans. Most commercial banks set their internal threshold at 1.25x or higher.
...
**If you have existing loans with DSCR covenants** (common in commercial real estate and equipment financing), a DSCR below the covenant level can trigger a [technical default](https://www.chase.com/business/knowledge-center/start/what-is-the-debt-service-coverage-ratio). The lender does not have to call the loan, but they can. More commonly, they restrict additional borrowing, require accelerated principal payments, or demand additional collateral.
...
We have written previously about [how to build a cash flow waterfall](/blog/ai-cash-flow-waterfall-explained) that shows where profit goes after EBITDA. This is the step before the waterfall: confirming that EBITDA is actually sufficient to begin with.
...
1. **Net Income** — bottom of the P&L
2. **Interest Expense** — in Other Expenses (or search for accounts with "interest" in the name)
3. **Depreciation** — usually in operating expenses under "Depreciation and Amortization"
4. **Amortization** — sometimes combined with depreciation, sometimes separate
5. **Annual principal payments** — this is NOT on the P&L. Check your loan schedules, or pull the Balance Sheet for the period and look at the change in long-term liabilities.
...
If your [balance sheet is distorted by bonus depreciation](/blog/bonus-depreciation-hiding-net-worth), the DSCR may look worse than reality because depreciation addbacks do not fully compensate for the asset write-down. A certified equipment appraisal can restore the balance sheet and improve your borrowing position.
...
That shift — from reporting what happened to asking whether the business can sustain what it owes — is the line between compliance accounting and advisory accounting. One tells you your EBITDA. The other tells you whether your EBITDA is enough. [Read how that transformation works](/about).
...
The [SBA requires a minimum of 1.15x](https://www.sba7a.loans/sba-7a-loans-small-business-blog/required-dscr/) for 7(a) loan approval. Most commercial banks want 1.25x or higher. A DSCR of 2.0x or above is considered strong and gives the business room for unexpected expenses, revenue dips, or growth investment.
...
**If your EBITDA is positive but your DSCR is below 1.25, you have a problem that is invisible on your P&L.** [Contact Benefique](https://www.benefique.com/contact) for a cash flow diagnostic that shows exactly where your debt service stands — by location, by quarter, with the same per-unit decomposition we used in this case study.
