...
description: "Data from 433 PET scans proves the 'keep the relationship' argument fails every time. A framework for per-referrer profitability analysis."
date: "2026-04-05"
...
slug: "referring-doctor-relationship-myth-medical-imaging"
metaTitle: "The Relationship Myth: When Taking One For The Team Costs $142,000"
metaDescription: "Data from 433 PET scans proves the keep the relationship argument fails. A per-referrer profitability framework for imaging centers."
keywords: "referring doctor profitability analysis, payer mix by referral source, imaging center referral ROI, toxic payer referring physician, medical practice referral value, radiology payer optimization, per-referrer P&L"
---
...
Here's what it looks like in practice, using anonymized data from our analysis. Drug costs ranged from $2,800 to $6,500 per dose depending on the tracer. [Toxic payers](/blog/toxic-payers-losing-money-medical-practice) — those reimbursing below drug acquisition cost — included a major managed care plan, a regional HMO, and a Medicare Advantage product with deeply discounted radiology rates.
...
If you're running a multi-location imaging center and don't know your per-referrer margin, [that's a conversation worth having](/contact).
...
The [Medical Group Management Association (MGMA)](https://www.mgma.com/data/benchmarking) benchmarking data consistently shows that referral source tracking is among the most underutilized data points in practice management — most groups track referral counts but fewer than 30% tie referral sources to financial outcomes.
...
Understanding these per-unit economics is the foundation of the [assembly line approach to practice profitability](/blog/assembly-line-thinking-medical-practice-profitability). Every encounter is a unit. Every unit has a cost. Every payer has a reimbursement rate. The math either works or it doesn't.
...
When your accounting function operates as [an ROI center instead of a cost center](/about), this is the kind of analysis that pays for itself in a single week.
...
**Running a multi-location imaging or specialty practice?** Benefique builds referral profitability dashboards that connect your billing data to referring doctor performance — updated live, not quarterly. [See what your data reveals →](/contact)
