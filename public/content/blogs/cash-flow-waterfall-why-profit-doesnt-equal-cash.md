...
slug: "cash-flow-waterfall-why-profit-doesnt-equal-cash"
metaTitle: "Cash Flow Waterfall: Why Profit Doesn't Equal Cash in Your Bank Account | Benefique"
metaDescription: "A cash flow waterfall shows where your operating profit actually goes — owner draws, debt service, working capital. Learn why profitable businesses run out of cash and how to fix it."
keywords: "cash flow waterfall small business, why profit doesn't equal cash, EBITDA vs cash flow, where does my profit go, cash flow waterfall chart, small business cash deficit, partner draws vs cash flow, working capital trap"
---
...
![Financial charts and data analysis on a professional desk showing business cash flow](/images/blog/cash-flow-waterfall-build.jpg)
...
- **Accounts Receivable:** Did AR grow? If AR went from $150K to $379K, that's $229K in cash tied up in unpaid invoices.
- **Inventory:** Did inventory grow? A $200K increase means $200K in cash sitting on shelves.
- **Accounts Payable (offset):** Did AP grow? If AP went up $50K, that's $50K you owe but haven't paid yet — it *helps* your cash position temporarily.
...
**Action:** Calculate [DSO (Days Sales Outstanding)](/blog/dso-350k-number-business-owners) = (AR / Revenue) x 365. If DSO is above 45, you have a collections problem. Calculate DIO (Days Inventory Outstanding) = (Inventory / COGS) x 365. If DIO is above 90, you're overstocked — the [Bureau of Labor Statistics industry data](https://www.bls.gov/iag/tgs/iag_index_naics.htm) can give you benchmarks for your sector. These are the two fastest levers to free cash without changing anything about your business model.
...
The [SBA's Standard Operating Procedure 50 10](https://www.sba.gov/document/support--sop-50-10-lending-criteria) lays out exactly how lenders must evaluate cash flow for SBA-backed loans — including the requirement to verify that historical cash flow can cover existing plus proposed debt service at 1.25x minimum.
...
*At [Benefique Tax & Accounting](https://www.benefique.com), we include cash flow waterfall analysis in every fractional CFO report. Built from your QuickBooks data using AI-powered analysis, the waterfall shows exactly where your operating profit goes — and what to do about it. [See what your banker really looks at](/blog/what-your-banker-sees-that-you-dont) or [learn how AI-assisted CFO analysis works](/blog/ai-cfo-analysis).*

*Want to see your own cash waterfall? [Contact us](/contact) — we build it from your existing QBO data in about an hour.*
