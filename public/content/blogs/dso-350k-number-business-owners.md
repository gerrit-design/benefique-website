...
description: "DSO measures how fast clients pay you. A 15-day improvement freed $353K for one firm. Here's the formula and 5 ways to cut yours."
date: "2026-03-12"
...
slug: "dso-350k-number-business-owners"
metaTitle: "DSO: The $350,000 Number Most Business Owners Have Never Heard Of | Benefique"
metaDescription: "DSO measures how fast clients pay you. A 15-day improvement freed $353K for one firm. Here's the formula and 5 ways to cut yours."
...
For context on how DSO connects to your broader cash cycle, see [Cash Conversion Cycle explained](/blog/how-to-calculate-cash-conversion-cycle) — DSO is one of three components, and it's typically the one with the most room to improve.
...
We wrote more about how AI-assisted analysis surfaced this specific situation in [how AI found $353K in trapped cash](/blog/ai-found-353k-trapped-cash). The short version: the data was in QuickBooks the whole time. The owner didn't have time to look at it at that level of detail. An automated analysis flagged it in minutes.
...
For a deeper breakdown of these strategies and how to implement them without damaging client relationships, see [5 ways to improve DSO](/blog/improve-dso-without-sacrificing-relationships).

You can also integrate DSO tracking into a regular 20-minute financial review — the structure for that is in [the monthly cash review](/blog/monthly-cash-review-20-minutes).
...
DSO is the most direct driver of operating cash flow for service businesses. Revenue is earned when the work is done. Cash is received when the invoice is paid. The gap between those two events is your DSO — and every day in that gap is a day your business is funding operations without the cash to show for it. Reducing DSO does not increase revenue on your income statement, but it dramatically improves the cash available to run and grow your business. See [Cash Flow Forecasting 101](/blog/cash-flow-forecasting) for how DSO fits into a full cash projection model.
...
**[Schedule a free 30-minute cash flow review with Benefique](https://www.benefique.com/contact)** — we'll pull the numbers from your QBO file and show you exactly where the cash is.
