...
**Capacity and payer mix decide the same dollar.** A filled slot on a slow-paying rail is not the same asset as a filled slot on a fast one - which is why the [Radiology Intelligence Pack](/radiology/intelligence-pack) reads net revenue per scan and days to cash off the same volume, across four centers. Fictional group, synthetic figures. A [Strategic Radiology Review](/radiology) runs it on yours.
