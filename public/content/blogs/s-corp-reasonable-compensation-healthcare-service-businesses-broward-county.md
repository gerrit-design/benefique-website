...
Set your salary too low, and the IRS reclassifies your distributions as wages -- retroactively. You owe back payroll taxes, 20% accuracy penalties, and interest. The total cost often exceeds **40% of the reclassified amount**.

Set your salary too high, and you're voluntarily paying FICA taxes on money that could have been distributed to you tax-free. Every dollar of salary above what's "reasonable" costs you **15.3%** in unnecessary payroll taxes (up to the Social Security wage base) or **2.9%** above it.
...
The IRS knows this. They know every S-Corp shareholder has an incentive to minimize salary and maximize distributions. And **73% of S-Corp audits focus specifically on whether the shareholder's compensation is reasonable**.

This isn't an obscure audit issue. It's the number one thing the IRS looks for in an S-Corp examination.
...
The IRS challenged it. Watson argued that $24,000 was fair for "administrative" work. The court disagreed. An expert witness used AICPA salary survey data to calculate that a CPA of Watson's experience performing his duties would command at least **$91,044** in the market. The court reclassified $67,044 in distributions as wages and assessed back payroll taxes plus interest.
...
- Zero salary with any amount of distributions
- Salary below 35% of S-Corp net income
- Salary significantly below industry benchmarks for your role and geography
- Distribution-to-salary ratio greater than 2:1
- Salary that hasn't changed in years despite growing revenue
...
That's $3,040 per year in unnecessary payroll taxes -- just from Medicare on the excess $80,000. Over 10 years, that's **$30,400** in taxes you didn't need to pay.
...
A board-certified orthopedic surgeon with 20 years of experience commands more than a recently licensed family medicine physician. A managing partner at a law firm commands more than a first-year associate. **Your credentials, certifications, and years of practice directly affect your compensation floor.**
...
- **Bureau of Labor Statistics (BLS)** -- bls.gov/oes, search by occupation code and Miami-Fort Lauderdale-West Palm Beach metropolitan area
- **MGMA surveys** -- Medical Group Management Association compensation data (physicians and administrators)
- **ADA surveys** -- Dental-specific compensation benchmarks
- **Robert Half, Hays, Glassdoor** -- Professional services salary surveys
- **RCReports** -- Formal reasonable compensation studies (designed specifically for this purpose)
...
The IRS rejects arbitrary percentage formulas like "60% salary / 40% distribution." Tax courts have explicitly stated there's no safe harbor percentage. Instead, use a **market-based analysis** that starts with comparable data and adjusts for your specific circumstances.
...
**Critical note:** These are starting points, not answers. Your specific number depends on your hours, your role, your geography, your experience, and your business complexity. A solo family medicine physician in Davie seeing 25 patients a day is in a different position than a physician who owns a multi-provider practice and spends half their time on administration.
...
**Your W-2 salary is NOT qualified business income.** Only the pass-through income (your K-1 distributive share) counts as QBI. So higher salary = lower QBI = smaller QBI deduction.
...
**QBI thresholds are individual.** Each partner's taxable income (including income from other sources, their spouse's income if filing jointly, and their specific deductions) determines their QBI eligibility independently. One partner may get the full QBI deduction while the other gets nothing -- and their salary strategies should differ accordingly.
...
- Patient care / client work
- Case management
- Treatment planning / project management

**Management/Administration:**
- Staff supervision and HR
- Vendor management
...
- **BLS Occupational Employment Statistics** (bls.gov/oes) -- Search your occupation code for the Miami-Fort Lauderdale MSA
- **Industry-specific surveys** (MGMA for physicians, ADA for dentists, AICPA for accountants)
- **Job postings** -- What are local practices and firms advertising for your role?
- **Recruitment firms** -- What are recruiters quoting for similar positions?
...
- **Low end** of your reasonable range
- **Midpoint** of your reasonable range
- **High end** of your reasonable range
...
- Your roles and time allocation
- The data sources you used
- Your adjustments and reasoning
- The final salary determination
- Date of the analysis
- Plan to review annually

This document is your audit defense. Without it, you're defending a number without evidence. With it, the IRS has to prove your analysis is wrong -- and that's a much harder burden for them.
...
And that's one year. The IRS typically looks back three years. Triple that exposure if your salary has been too low for multiple years.
...
- **Revenue changes significantly** (up or down by 15%+)
- **Your role changes** (hired a practice manager? your management duties decreased)
- **You add or reduce clinical hours**
- **Market data changes** (new BLS data or salary surveys)
- **Tax law changes** (like the OBBBA changes to QBI, FICA thresholds, or retirement limits)
- **The Social Security wage base increases** ($184,500 in 2026, up from $176,100 in 2025)

The best time to set next year's salary is **December** -- before the new tax year begins. This lets you optimize for known tax rates, contribution limits, and QBI thresholds.
...
If you recently made the S-Corp election (which we cover in our [S-Corp Election guide](/blog/s-corp-election)), set your salary from Day 1 of S-Corp status. The IRS will look at the full period of S-Corp treatment, so even partial years need reasonable compensation.
...
The right number isn't a guess. It's not a percentage. It's not "what my buddy who's also a dentist pays himself." It's a documented, defensible figure based on market data, adjusted for your specific role, hours, experience, and geography -- and optimized against your QBI deduction, retirement plan contributions, and total tax position.
