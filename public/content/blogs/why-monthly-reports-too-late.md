...
*This is Part 1 of the [Cash Flow Intelligence Series](/blog/ai-powered-cash-flow-intelligence).*
...
- **Day 31-38:** Bank reconciliation, credit card statements, payroll journal entries. Only 53% of companies finish this within 6 business days ([Ledge, 2025](https://www.ledge.co/content/month-end-close-benchmarks-for-2025)).
...
**48% of small businesses report cash flow problems** ([QuickBooks, 2025](https://quickbooks.intuit.com/r/cash-flow/cash-flow-problems/)). But most of these aren't caused by lack of revenue. They're caused by timing. Money comes in waves. Money goes out on fixed schedules. The gap between those two rhythms is where businesses break.
...
1. **Current cash position** (bank balance minus pending outflows)
2. **Accounts receivable aging** (who owes you, and how late)
3. **Days Sales Outstanding** (how fast you collect, on average)
4. **Cash runway** (at current burn rate, how many weeks until $0)
5. **Revenue vs. last month** (trend line, not just a number)
