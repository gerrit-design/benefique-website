...
**Quick answer:** Most radiology lines of credit are mispriced because the banker is applying a commercial-A/R borrowing-base formula to healthcare receivables. For a Florida radiology practice, a 25–35% Net Collection Rate with 55–60% of gross A/R in the 120+ day bucket is normal and healthy — it reflects the chargemaster-to-contract spread and the LOP settlement cycle, not a collection problem. Three numbers — gross charges billed, cash collected, and the Net Collection Rate between them — translate the aging report into language a credit committee actually understands.
...
- **Morgan & Morgan, P.A.** — the largest personal injury law firm in the United States, 1,000+ attorneys across 50+ offices, $2 billion+ in annual revenue, and a multi-decade track record of settling cases and paying medical providers on executed letters of protection.
- **Farah & Farah** — one of the oldest and largest personal injury firms in the Southeast.
- **Steinger, Greene & Feiner** — long-operating high-volume Florida personal injury practice.
- **Pelosi Injury Law, Rubenstein Law, and similar established Florida PI firms**, each with multi-decade settlement histories and well-documented payment practices.
...
**Why is most of my radiology A/R in the 120+ day bucket?**
Because of how healthcare billing works, not because of a collection problem. The 120+ concentration is driven almost entirely by the Letter of Protection segment, which settles on a 12-to-36-month cycle through the personal injury litigation process. A practice with 35–45% LOP in its A/R will normally show 55–60% in 120+ days even with a perfectly run billing operation.

**What is a good Net Collection Rate for a radiology practice?**
For a Florida radiology practice, 25–35% NCR is the normal range, depending on payer mix. The absolute number matters less than the stability: a practice holding a consistent NCR over twelve rolling months is performing correctly, even if the number looks "low" compared to commercial business expectations. Stability, not magnitude, is the billing health indicator.

**Is LOP (Letter of Protection) A/R actually collectible?**
Yes, when it sits against tier-1 Florida personal injury firms, which is where most of it does. Morgan & Morgan, Farah & Farah, Steinger Greene, and similar established firms have multi-decade settlement histories and reliable payment practices on executed LOPs. The issue is not collectibility — it is the 12-to-36-month duration, which means charges are recognized immediately but cash realizes over the settlement cycle.

**How should I explain healthcare A/R to my commercial banker?**
Send the aging report with a one-page translation memo covering six things: a chargemaster explainer, a payer-class breakdown, an LOP counterparty table, a twelve-month cash run rate with coefficient of variation, any specialty receivables segmented out, and raw enough data for the credit team to run their own DSCR calculation. Do not compute the DSCR for them — they prefer to run it themselves on inputs they trust.

**Should I include LOP receivables in my borrowing base?**
