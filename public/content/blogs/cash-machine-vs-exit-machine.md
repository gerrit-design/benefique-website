...
description: "Run the business to pay you forever, or build it to sell? The 80/20 framework that turns drift into decision — and recovers $3M of lost value."
date: "2026-05-06"
...
slug: "cash-machine-vs-exit-machine"
metaTitle: "Cash Machine or Exit Machine: Owner's Decision | Benefique"
metaDescription: "Should you run your business as a long-term cash generator or build it to sell? The 80/20 framework that reveals which operational choices matter most."
keywords: "should I sell my business or keep it, exit planning small business, business sale vs hold, owner succession planning, build or sell business, business exit strategy, cash flow business vs sale"
---
...
- *Should I buy the new building or keep renting?*
- *Do I hire a GM, or keep running this myself?*
- *Should I take the distribution this year or leave it in the business?*
- *Do I pay off the SBA loan early?*
- *Is it time to expand into a second location?*
...
- Steady, even distributions to owners
- Low debt (debt service competes with owner draws)
- Minimal discretionary capex unless it pays back within 24 months
- Lean hiring; owners work fewer hours each year as systems mature
- Reinvestment limited to preserving competitive position, not chasing growth

### The Exit Machine

The Exit Machine is optimized to maximize enterprise value at a specific sale date 3–7 years in the future. The goal is the highest possible EBITDA × multiple at exit — a single large liquidity event rather than a long stream of smaller distributions. The general tax treatment of that liquidity event is governed by [IRS Publication 544](https://www.irs.gov/publications/p544) on sales and other dispositions of assets, and is worth reading before you commit to a sale timeline.

Key characteristics of a well-run Exit Machine:
- Reinvestment tilted toward growth in years 1–2 of the sale runway
- Recurring-revenue programs built and maturing before sale date
- Documented leadership layer below the owner (removes key-person discount)
- Clean 3 years of audited or reviewed financials in the data room
- A final "steady-state" year (typically year 3) where the business is presentable as boring and predictable
...
| **Eliminate intergroup pricing ambiguity (written, reviewed-annually policy)** | Cleaner books; fewer owner-disputes | Passes [IRS §482 arm's-length standard](https://www.irs.gov/irm/part4/irm_04-061-003) in data room |
...
- Rule of 40 score: 30 (below the PE screening threshold of 40)
- Today's enterprise value at 4x EBITDA: ~$1.36M
...
Answer the five questions. Align your partners. Choose the goal. Let the operational calendar follow. [This is the kind of conversation that changes the arc](/contact) — not because we told you what to do, but because we gave you the frame to decide.

---

## Frequently Asked Questions

**Is this just about preparing to sell?**
No. The framework is equally useful for owners committed to never selling. A well-run Cash Machine is a specific thing — and it is not the same thing as an accidentally-run business with unclear goals. The discipline of deciding makes either path better; the lack of decision makes both paths worse.

**How often should I revisit the decision?**
Annually at minimum, and immediately whenever a major life event intrudes — partner change, health event, market shift, unsolicited offer. The decision is not permanent. But it should be explicit.

**What if my partner and I disagree on the path?**
...
**Does this apply to businesses under $1M in revenue?**
The framework applies. The numbers compress — the multiple premium for recurring revenue is smaller, the enterprise value ranges are lower, the leverage from leadership hires is less — but the 80/20 overlap/divergence pattern holds. Smaller businesses often need the framework more, because drift is harder to detect at smaller scale.

**How long does the Exit Machine path actually take?**
Plan on 36–48 months of disciplined execution from decision to closing. Shorter timelines are possible for businesses already well-run — but they are exceptions. Most businesses need the full 36–48 months to build the recurring revenue, leadership, and clean-books elements that move the multiple from 3x to 4.5x+.
