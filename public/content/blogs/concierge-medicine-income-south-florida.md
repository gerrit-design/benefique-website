...
Before the income discussion, the distinction matters. The [AAFP provides a detailed overview](https://www.aafp.org/about/policies/all/direct-primary-care.html) of direct patient care models:
...
The [Medscape 2025 Physician Compensation Report](https://www.medscape.com/sites/public/physician-comp/2025) puts the median primary care salary at $280,000–$300,000. The median concierge physician in South Florida earns roughly double that while seeing one-fifth the patients.
...
Not every market supports concierge medicine equally. Broward County's nearly [2 million residents](https://worldpopulationreview.com/us-counties/florida/broward-county) include significant concentrations of high-net-worth individuals:

- **Weston** — Median household income over $100,000, young professional families
- **Parkland** — One of the wealthiest zip codes in Florida
- **Fort Lauderdale (Las Olas, Rio Vista, Harbor Beach)** — Executives and retirees
- **Coral Springs** — Growing affluent population, underserved in concierge options
- **Davie/Southwest Ranches** — Affluent families, limited concierge presence
...
At concierge income levels, operating as a sole proprietorship means paying self-employment tax (15.3%) on all net income up to the [Social Security wage base of $184,500 (2026)](https://www.ssa.gov/oact/cola/cbb.html), plus 2.9% Medicare tax on everything above, plus the 0.9% Additional Medicare Tax above $200,000.

An [S-Corp election](/blog/s-corp-election) (filed via [IRS Form 2553](https://www.irs.gov/forms-pubs/about-form-2553)) splits income between [reasonable compensation](/blog/s-corp-reasonable-compensation-healthcare-service-businesses-broward-county) (subject to payroll taxes) and distributions (not subject to self-employment tax).
...
Source: [IRS Notice 25-67](https://www.irs.gov/pub/irs-drop/n-25-67.pdf). Cash Balance Plan amounts are actuarially determined and vary by age — a 50-year-old physician can shelter roughly $204,000; a 60-year-old can shelter over $328,000.

A concierge physician earning $800,000 who implements S-Corp election, maximizes a Cash Balance Plan, and uses an accountable plan can reduce their effective federal tax rate from 37% to under 25%. For a deeper breakdown, see our guide to [tax strategies for concierge physicians](/blog/tax-strategies-concierge-physicians).

If your patients are asking whether their membership fees are deductible, see our guide on [whether concierge medical fees are tax deductible](/blog/concierge-medical-fees-tax-deductible).

## Case Study: A Weston Launch

Dr. Rivera practiced internal medicine in a hospital-owned group for 12 years, earning $310,000 with no equity and no autonomy. She launched a concierge practice in Weston. (See our [startup cost breakdown](/blog/cost-starting-concierge-medical-practice) for what the initial investment looks like.)
...
> **Try the Simulator:** Model your own P&L and cash flow as you grow your patient panel. The [Concierge Medicine Financial Simulator](/tools/concierge-simulator) lets you adjust membership fees, costs, and physician salary.
...
| Effective tax rate | Under 30% | [Tax structure](/blog/tax-strategies-concierge-physicians) efficiency |
| Retirement contributions | Maximize annually | [Wealth accumulation](/blog/concierge-physicians-build-wealth-beyond-practice) |
...
The evolution from backward-looking tax prep to forward-looking financial intelligence is what separates [cost-center accounting from ROI-center accounting](/about).

## Frequently Asked Questions

### How much does a concierge doctor make in Florida?

Concierge physicians in South Florida typically earn $500,000 to $1,000,000+ in net income, compared to $280,000–$300,000 for insurance-based primary care ([Medscape 2025](https://www.medscape.com/sites/public/physician-comp/2025)). Income depends on membership fee ($2,000–$15,000/year), panel size (200–500 patients), and overhead structure. See our [full financial comparison](/blog/concierge-medicine-vs-insurance-practice-financial-comparison).
...
S-Corp election saves $17,000–$35,000/year in self-employment taxes. Retirement plan stacking with a Cash Balance Plan can shelter $200,000–$400,000 annually. Combined with proper entity structuring, effective tax rates drop from 37% to under 25%. See our [complete tax strategies guide](/blog/tax-strategies-concierge-physicians).

### How long does it take to build a concierge patient panel?

Converting an existing practice: 6–12 months to breakeven, 12–24 months to target income. Starting from scratch: 12–18 months to breakeven. Joining MDVIP or similar network: 3–6 months. Our [startup cost guide](/blog/cost-starting-concierge-medical-practice) covers the full timeline.
...
- [Concierge Medicine vs Insurance Practice: The Financial Case](/blog/concierge-medicine-vs-insurance-practice-financial-comparison)
