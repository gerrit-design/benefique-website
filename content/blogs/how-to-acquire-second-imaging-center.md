...
description: "The financial roadmap for acquiring a second imaging center in SE Florida — valuation, deal structure, debt stack, integration math, and the 90-day post-close playbook."
date: "2026-04-29"
...
slug: "how-to-acquire-second-imaging-center"
metaTitle: "How to Acquire a Second Imaging Center | Benefique"
metaDescription: "The financial roadmap for buying a second imaging center in SE Florida 2026 — valuation, deal structure, debt stack, integration math, post-close playbook."
keywords: "acquire second imaging center, buy imaging center, imaging center acquisition, radiology center M&A, imaging center valuation, imaging center deal structure, second imaging center financing"
---
...
For a longer treatment of the underlying multiple drivers across SE Florida imaging, see [Multi-Center Imaging Owner Income: 2026 SE Florida Benchmarks](/blog/multi-center-imaging-owner-income-2026-sefl).
...
1. **Buyer gets a step-up in basis** on acquired assets, which produces ongoing depreciation deductions that are economically valuable. The allocation of purchase price across asset classes ([IRS Form 8594, Asset Acquisition Statement](https://www.irs.gov/forms-pubs/about-form-8594)) is jointly negotiated and matters substantially for both parties' tax positions.
2. **Seller faces ordinary-income recapture** on equipment and depreciation recapture, plus capital-gains treatment on goodwill. The buyer's preferred allocation (heavy on tangible assets and equipment, lighter on goodwill) is the seller's least favorite (capital gains treatment on goodwill is preferred). Allocation negotiation is a real economic piece of the deal.
3. **Liability isolation** — buyer takes only the liabilities specifically assumed in the purchase agreement. Pre-closing exposure (malpractice, employment disputes, payer audits, billing-company disputes) stays with the seller's entity. This is the structural reason asset deals dominate at this scale.
...
- **SBA 7(a) loan**, often in the $1M–$5M range, with longer amortization than conventional debt ([SBA 7(a) program details](https://www.sba.gov/funding-programs/loans/7a-loans))
...
(For the related framing on DSCR and lender behavior, see [Why Your Business Loan Was Denied (And The 60 Percent Rule)](/blog/distribution-ratio-business-loan).)
...
The fix: model integration explicitly, fund it from a dedicated integration reserve at close (not from operating cash), and hold yourself to the integration budget like a real budget. (For more on growth reinvestment and working-capital discipline, see the related distribution-ratio framing in [Why Your Business Loan Was Denied (And The 60 Percent Rule)](/blog/distribution-ratio-business-loan).)
...
**Day 15–45:** **Run a Strategic Radiology Review on the acquired center.** Per-payer DSO decomposition (see [DSO Benchmarks for Imaging Centers](/blog/dso-benchmarks-imaging-centers-2026-sefl)), per-modality contribution analysis (see [Per-Modality Profitability](/blog/per-modality-profitability-imaging-center)), and LOP yield-adjusted A/R review (see [LOP Economics: Real Yield vs Face Value](/blog/lop-economics-real-yield-vs-face-value)). The review confirms or refutes the buyer-side normalization assumptions used to value the deal.
...
- **Bonus depreciation and Section 179** — equipment acquired in the deal is eligible for accelerated depreciation, often dramatically reducing year-of-acquisition taxable income. Bonus depreciation continues to phase down in 2026 ([IRS Pub 946 / Section 168(k)](https://www.irs.gov/publications/p946)), so timing decisions matter.
...
- **Goodwill amortization** — under [IRC Section 197](https://www.irs.gov/publications/p535), goodwill is amortized straight-line over 15 years. This is the principal post-close tax shield in most asset-deal acquisitions.
...
**How long does post-close integration actually take?**
The 90-day playbook is the active-management window. Full operational integration typically runs 6–12 months. Full financial-system unification typically runs 9–18 months. The most common mistake is to attempt all of it inside the first 90 days, which destabilizes both centers and creates avoidable referrer and staff churn. Slow integration is almost always the right answer.
