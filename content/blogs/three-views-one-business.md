...
It doesn't work when you walk into a bank for a [line of credit](https://www.sba.gov/funding-programs/loans) and get declined despite being "profitable." It doesn't work when a potential acquirer values your $4M revenue practice at $500K. It doesn't work when your partner wants to buy you out and the number on the table is a fraction of what you expected.
...
![Financial dashboard showing multiple metrics and KPIs for a healthcare business](/images/blog/three-views-financial-dashboard.jpg)
...
The [cash flow waterfall](/blog/ai-cash-flow-waterfall-explained) we've written about before reveals part of this gap: the difference between P&L profitability and actual cash movement. But even the waterfall is only the operational view. There are two more lenses that most owners never see.
...
**Negative equity of $2.5M** means the business owes more than it owns. On paper, it's insolvent. The banker flags this immediately. In healthcare imaging, this is often driven by equipment financing and [accelerated depreciation](https://www.irs.gov/publications/p946) (Section 179, bonus depreciation) — the equipment is worth more than the book value shows. A good banker knows this. A cautious banker still flags it.
...
**The operator thought: "We're doing okay."**
**The banker thinks: "You can service debt, but you're fragile."**
...
**EBITDA is the currency of acquisition.** Buyers don't care about net income — it's distorted by depreciation, interest, and tax strategies. They care about [EBITDA](https://www.investopedia.com/terms/e/ebitda.asp): how much cash the business operations actually produce. At $336K TTM EBITDA, a typical healthcare services multiple of 3-5x would price this business at $1.0M to $1.7M.
...
**The operator thought: "We're turning the corner."**
**The banker thought: "Lendable with conditions."**
**The buyer thinks: "Distressed. Lowball or pass."**
...
- **Loan applications** succeed or fail based on the gap between View 1 and View 2
- **Acquisitions** are won or lost based on the gap between View 1 and View 3
- **Partner buyouts** get ugly when one side uses View 1 and the other uses View 3
...
![Business professionals reviewing financial statements across multiple views](/images/blog/three-views-business-meeting.jpg)

## How AI Changes the Game

Traditional accounting gives you View 1 and calls it a day. Your monthly P&L, your balance sheet, maybe a [cash flow statement](https://www.fasb.org/page/PageContent?pageId=/standards/accounting-standards-codification.html) if you ask. That's the operator's view.
...
1. **Calculate your DSCR.** Take your TTM EBITDA (from your P&L — net income plus interest, taxes, depreciation, and amortization) and divide it by your annual debt payments. If it's below 1.25x, you have a debt service problem that your P&L isn't showing you. The [SBA considers 1.25x the minimum](https://www.sba.gov/funding-programs/loans) for most loan programs.

2. **Check your equity.** Open your balance sheet. Subtract total liabilities from total assets. If the number is negative, your business is technically insolvent on paper — even if it's operationally profitable. This is often driven by [accelerated depreciation](https://www.irs.gov/publications/p946) (bonus depreciation, Section 179) and doesn't mean the business is failing. But it does mean a banker will ask questions.
...
**If you want all three views built from your QuickBooks data in one session**, [schedule a discovery call](/contact). We'll show you what your banker and a buyer would see — before they do.
...
**Ready to see what your banker and a buyer see in your financials?** [Schedule a discovery call](/contact) or read how we built the [cash flow waterfall](/blog/ai-cash-flow-waterfall-explained) that powers View 1.
