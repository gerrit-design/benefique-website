...
description: "Most practices track one break-even number. There are two. The gap between them is where cash disappears. Here's the 3-step calculation and why AI made it accessible."
date: "2026-03-24"
...
slug: "cash-flow-breakeven-per-patient-activity-units"
metaTitle: "Cash Flow Break-Even Per Patient: The Number Your Accountant Isn't Watching | Benefique"
metaDescription: "Your practice has two break-even numbers. The P&L one is 702 patients. The cash flow one is 922. Here's how to calculate both — and why the gap matters more than either."
keywords: "cash flow breakeven per patient, practice cash flow breakeven analysis, breakeven in claims not dollars, cash flow breakeven vs profit breakeven, activity unit breakeven, per-patient breakeven, two breakevens healthcare, AI cash flow analysis, real-time financial intelligence, healthcare practice advisory gap, fractional CFO cost healthcare"
schema:
  type: "Article"
  faq: true
  about:
    ...
    - "Healthcare Practice Financial Intelligence"
    - "AI-Powered Financial Analysis"
    - "Advisory Gap for Small Practices"
  mentions:
    - type: "Organization"
      name: "MGMA"
    - type: "Organization"
...
*This is Part 8 of the [Cash Flow Intelligence Series](/blog/ai-powered-cash-flow-intelligence).*
...
- **Estimated tax payments:** For pass-through entities (S-Corps, partnerships, sole proprietorships), the [IRS requires quarterly estimated tax payments](https://www.irs.gov/businesses/small-businesses-self-employed/estimated-taxes) on the owner's share of income
...
Want to know your two break-even numbers? [Start here](/contact).
...
For the imaging center we analyzed, the [cash flow waterfall](/blog/ai-cash-flow-waterfall-explained) told the full story:
...
- **Healthcare consultant hourly rates:** $250–$500/hour (CLA, [MGMA](https://www.mgma.com/)-tier advisory firms)
...
- **Industry benchmarks** that require a $399+ [MGMA membership](https://www.mgma.com/) just to access, and a decade of context to interpret
...
Finding someone who understands BOTH the financial modeling AND the healthcare operations is a needle-in-a-haystack problem. The [Healthcare Financial Management Association](https://www.hfma.org/) has 90,000+ members — but most work for hospital systems, not five-provider imaging centers.
...
- **42% of physicians** remain in independent private practice, down from 60% in 2012, according to the [AMA Physician Practice Benchmark Survey](https://www.ama-assn.org/practice-management/physician-practice-arrangements/ama-physician-practice-benchmark-survey)
...
1. **Engagement starts:** Week 1
2. **Data request and access setup:** Weeks 1–2
3. **Data extraction and normalization:** Weeks 2–3
4. **Analysis and modeling:** Weeks 3–5
5. **Report writing and review:** Weeks 5–6
6. **Deliverable presented:** Weeks 6–8
...
- **Per-unit economics** calculated automatically for every expense line — not just totals, but cost per claim for rent, per claim for payroll, per claim for supplies, per claim for billing fees (see our [per-unit P&L framework](/blog/per-unit-pnl-multi-location-cost-analysis))
...
- **Cash flow waterfall** decomposed to show exactly where every EBITDA dollar goes — operations, debt, distributions, taxes, working capital (see our [waterfall methodology](/blog/ai-cash-flow-waterfall-explained))
...
For practices that want to go deeper into the fixed-cost dynamics driving their break-even, our [fixed-cost break-even analysis](/blog/fixed-cost-breakeven-volume-problem) walks through the operating leverage math step by step.
...
Because profit and cash are not the same thing. Debt service principal, owner distributions, estimated tax payments, and growing accounts receivable all consume cash without appearing on the income statement. If your volume is between your P&L break-even and your cash flow break-even, you're profitable AND losing cash simultaneously. See our [cash flow waterfall analysis](/blog/ai-cash-flow-waterfall-explained) for a visual breakdown of where EBITDA actually goes.
