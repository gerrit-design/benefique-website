...
slug: "2026-tax-law-changes-broward-county-healthcare-service-businesses"
metaTitle: "2026 Tax Law Changes for Healthcare & Service Businesses in Broward County | Benefique"
metaDescription: "The One Big Beautiful Bill Act changed everything: 100% bonus depreciation is back, Section 179 jumped to $2.56M, QBI is permanent, and the dependent care FSA doubled to $7,500. Here's what Broward County practice owners and service business operators need to do before year-end."
...
![Medical practice equipment qualifies for 100% bonus depreciation under 2026 tax law](/images/blog/medical-equipment-depreciation.jpg)
...
**What qualifies:**
- Medical and dental equipment (chairs, lasers, imaging, sterilization)
- Computer systems and practice management software
- Tenant improvements and office build-outs (qualified improvement property)
- Furniture and fixtures
- Vehicles over 6,000 lbs GVWR (see below)
- Technology infrastructure (servers, networking, security systems)

**What doesn't qualify:**
- Land
- Buildings themselves (the structure, not improvements)
...
Not sure if your cash flow can handle a major equipment purchase? [Read about our Cash Flow Advisory service](/blog/cash-flow-management-healthcare-service-businesses-broward-county) or book a diagnostic call.
...
- **Section 179 deduction:** Up to **$32,000**
- **Bonus depreciation:** 100% on the remaining cost, no cap
- **Combined:** You can potentially deduct the **full purchase price** in year one
...
- Therapists (physical, mental health, occupational)
- Veterinarians
- Attorneys
...
![Professional services owners need to understand QBI deduction phase-outs and planning strategies](/images/blog/qbi-deduction-planning.jpg)
...
3. **Manage S-Corp salary.** If you've elected S-Corp (and you should read our [S-Corp Election guide](/blog/s-corp-election) if you haven't), your reasonable salary affects both QBI and payroll taxes. These interact -- optimize them together, not separately.
...
![Retirement contribution limits increased significantly for practice owners in 2026](/images/blog/retirement-planning-2026.jpg)
...
- [ ] **Recalculate your estimated tax payments.** If you're planning a major equipment purchase, your 2026 tax liability may be significantly lower than last year. Overpaying estimates ties up cash unnecessarily.
- [ ] **Identify equipment purchases to accelerate.** That new treatment chair, imaging system, or technology upgrade you planned for 2027? Buying it in 2026 gets you 100% bonus depreciation. Run the numbers.
- [ ] **Check your SSTB status and QBI threshold.** Are you above or below the phase-out? If you're in the range ($398K-$548K MFJ), retirement contributions and equipment deductions could push you into full QBI eligibility.
- [ ] **Update your dependent care FSA election.** If you have kids in daycare and you're at the old $5,000 limit, increase to $7,500. Call your plan administrator.

**Before September 30 (Q3 estimated taxes):**

- [ ] **Open or fund retirement plans.** Solo 401(k) and defined benefit plans need to be established by December 31 of the tax year (though contributions can be made later). Start the paperwork now.
- [ ] **Review S-Corp reasonable salary.** Does your current salary put you in the right position for both payroll tax savings AND QBI eligibility? These interact. Optimize together. [Read our S-Corp guide](/blog/s-corp-election).
- [ ] **Model year-end scenarios.** What happens if revenue comes in 10% higher than expected? 10% lower? What equipment purchases make sense at different income levels?

**Before December 31:**

- [ ] **Execute equipment purchases.** Property must be placed in service (not just ordered) by 12/31 to qualify for 2026 deductions.
- [ ] **Fund retirement accounts.** Solo 401(k) employee deferrals must be made by 12/31. Employer contributions can wait until the tax filing deadline.
- [ ] **Consider charitable giving strategies.** If you're on the edge of the SSTB phase-out, a donor-advised fund contribution can pull you under the threshold.
- [ ] **Review entity structure.** If you're not an S-Corp and your profit is consistently above $100K, [this is the analysis to do](/blog/s-corp-election).

### If You Run a Professional Services Firm:

**Same timeline as above, plus:**

- [ ] **Review 1099 vs. W-2 classifications.** If you're bringing on contractors, the OBBBA didn't change misclassification rules -- the IRS is still aggressive here. Make sure your classifications are clean.
- [ ] **Plan technology investments.** Software, hardware, and security infrastructure qualify for both Section 179 and bonus depreciation. If you've been underinvesting, 2026 is the year to catch up.
- [ ] **Model the QBI impact on partner compensation.** For multi-owner firms, each partner's taxable income determines their QBI eligibility independently. One partner might get the full deduction while another gets nothing.
...
No. Late election relief is available. [Read our full guide on S-Corp election timing](/blog/s-corp-election), including the late election process.
...
- Your actual income and payer mix
- Your equipment needs and purchase timing
- Your retirement contributions and QBI threshold
- Your S-Corp salary and distribution split
- Your cash flow reality (can you afford the deduction?)
