...
const blogPosts = {
  ...
  'how-to-start-concierge-medical-practice': {
    ...
    title: 'How to Start a Concierge Medical Practice: Step-by-Step (2026)',
    date: '2026-03-17',
    author: 'Gerrit Disbergen, EA',
    excerpt: 'From entity formation ($2K-$5K) and S-Corp election to building your first 200-patient panel \u2014 the financial roadmap for launching a concierge practice. Includes the corporate B2B play worth $50K-$200K/year that most physician consultants skip.',
  ...
  'real-time-financial-dashboards-healthcare-practices': {
    ...
    title: 'Real-Time Financial Dashboards for Healthcare Practices: 10 KPIs',
    date: '2026-03-05',
    author: 'Benefique Tax & Accounting',
    excerpt: 'Collection rate, AR aging, overhead ratio, DSO, cash runway \u2014 these 10 KPIs should update daily, not monthly. Includes specific benchmarks for dental, radiology, and physician practices so you know exactly where your numbers should be.',
    categories: ['Cash Flow Advisory', 'Healthcare Finance', 'Financial Intelligence'],
    readTime: '11 min read',
