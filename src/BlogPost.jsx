...
const blogPosts = {
  ...
  'selling-imaging-center-what-buyers-pay': {
    ...
    faqs: [
      { q: 'How much is my imaging center worth in 2026?', a: 'A single center or small tuck-in commonly trades around 4–7x EBITDA — the range RadNet\'s CFO has said on the record the company pays — while scaled public imaging platforms trade closer to 10–12x trailing EBITDA (per valuation firm VMG Health). Owner-operated centers under about $1M earnings are often priced on a 2–4x SDE multiple instead. The exact number inside the range is decided in diligence, not in the LOI.' },
      ...
      { q: 'What deal terms matter besides the multiple when selling an imaging center?', a: 'Cash at close, rollover equity (~10–30%), earnout (about a third of deals carry one, with a median near 43 percent of the closing payment), escrow/holdback (~1 percent of value, or a small reps-and-warranties insurance retention), the working-capital peg, reps and warranties, and the employment agreement plus non-compete. A 5–6x headline can leave materially less than that as certain cash at close, with the rest contingent or illiquid.' },
      { q: 'Does my PET tracer business make my imaging center worth more or less?', a: 'It can lower your blended multiple. PET tracer income is high-dollar per claim but concentrated, payer-variable (amyloid PET lost its national Medicare coverage determination in October 2023, so coverage now varies by region), and carries a tracer cost incurred before the claim is collected. Buyers price that risk through a lower blended multiple, an EBITDA haircut, or a larger earnout — so a center over-dependent on PET often clears lower, not higher.' },
      { q: 'How early should I prepare to sell my imaging center?', a: 'Two to five years out. The drivers that move your multiple — referral diversification, payer mix, the PET/radiology split, ending recurring one-time costs, three to four quarters of improving trend — take quarters to fix, not weeks. A seller who runs their own Quality of Earnings early clears closer to the headline than one who first sees the analysis in the buyer\'s report.' },
  ...
  'dso-benchmarks-imaging-centers-2026-sefl': {
    ...
    faqs: [
      ...
      { q: 'Is Florida PIP being repealed in 2026?', a: 'No. Despite recurring rumors, the Florida no-fault PIP statute (F.S. 627.736) remains in force in 2026. Operators planning around a near-term repeal are planning around a fiction. The right strategy is to manage PIP to its own benchmark (90–150 days median), not to expect statutory relief.' },
  ...
  'concierge-medical-fees-tax-deductible': {
    ...
    title: 'Are Concierge Medical Fees Tax Deductible? The 2026 Answer (HSA, FSA, Schedule A)',
    date: '2026-04-08',
    author: 'Gerrit Disbergen, EA',
    excerpt: 'Direct answer for patients and CPAs: when MDVIP and concierge fees ARE deductible, when they are not, and how HSA, FSA, and Schedule A rules apply for 2026.',
  ...
  'concierge-medicine-income-south-florida': {
    ...
    title: 'Concierge Medicine Income in South Florida: 2026 Salary Benchmarks',
    date: '2026-03-07',
    author: 'Gerrit Disbergen, EA',
    excerpt: 'What South Florida concierge doctors actually earn in 2026, broken down by panel size, fee structure, and Davie/Broward market data. Net $500K to $1M+ with 200 to 500 patients.',
  ...
  'cost-starting-concierge-medical-practice': {
    ...
    date: '2026-03-08',
    author: 'Gerrit Disbergen, EA',
    excerpt: '$75K–$200K to launch a concierge medical practice in 2026. Most Broward County physicians land at $100K–$175K. Full line-item breakdown: entity setup, buildout, EHR, marketing, $19,750/mo fixed costs, and the S-Corp election deadline most consultants forget.',
  ...
  'concierge-doctor-300-patient-panel-income': {
    ...
    date: '2026-04-08',
    author: 'Gerrit Disbergen, EA',
    excerpt: '300 patients × $350/mo = $1.26M gross. After $356K overhead, W-2 salary, payroll tax, Cash Balance Plan, and federal tax: $430K take-home in 2026. Every dollar of the math, step by step.',
    categories: ['Concierge Medicine', 'Physician Finance', 'Tax Strategy'],
    readTime: '14 min read',
  ...
  'ai-found-353k-trapped-cash': {
    ...
    date: '2026-03-12',
    author: 'Gerrit Disbergen, EA',
    excerpt: 'A real working capital diagnosis: 4 hidden cash leaks, a 6-week recovery plan, and the AI workflow that surfaced $353K already sitting in the books.',
    categories: ['Cash Flow'],
    readTime: '11 min read',
  ...
  'expensive-2-minute-decision-medical-practice': {
    ...
    faqs: [
      { q: 'What is a pre-authorization gate for high-cost procedures?', a: 'It is an internal checkpoint between scheduling a procedure and ordering the high-cost input (drug, implant, device). It is not insurance prior authorization \u2014 that is the payer\'s process. This is the practice\'s own financial gate that asks: based on this payer\'s history, will we get paid enough to cover the input cost?' },
      { q: 'How much does a toxic payer scan actually cost a practice?', a: 'Drug acquisition alone ranges from $2,800 to $6,500 per dose depending on the tracer. Add staff time, equipment, and facility overhead and the total is higher. But the drug is the irreversible component \u2014 once injected, it cannot be recovered. In the network we analyzed, one managed-care payer generated 20 scans at $49,756 in drug costs and $0 collected.' },
      { q: 'What payers should trigger a Tier 2 review?', a: 'Any payer with a documented history of underpaying or non-paying on high-cost procedures. Any payer not yet seen for a specific drug-procedure combination. Any combination where loss probability exceeds 50%. And any encounter where the drug cost exceeds $5,000.' },
      { q: 'How long does it take to implement a pre-authorization workflow?', a: 'One to two weeks. You need payer-drug combinations graded by historical margin, a flag system at scheduling, and an operations reviewer empowered to approve or deny. No software to purchase. Ongoing cost: 10 minutes per day.' },
      { q: 'Does this replace insurance prior authorization?', a: 'No. Insurance prior authorization is the payer\'s requirement. The internal authorization gate is in addition to the payer\'s process. The payer asks: is this procedure medically necessary? Your gate asks: if we perform this procedure for this payer, will we get paid enough to cover the drug cost?' }
    ]
  },
  'dso-lying-medical-practice-cash-flow': {
    ...
    faqs: [
      { q: 'What is a good DSO for a medical practice?', a: 'MGMA benchmarks place best-practice DSO at 30-40 days, with anything under 45 days considered acceptable. But the single number matters less than the distribution. A 38-day DSO with a tight distribution is healthier than a 32-day DSO with a bimodal split and a tail of 90+ day claims.' },
      { q: 'Why is my practice\'s DSO higher than the benchmark?', a: 'Common causes: bimodal payer distributions, data quality issues at intake producing rejections or delays, denial rates above the 12% industry average, and a mix of payers with structurally different payment timelines. Decomposing by payer tells you which cause is driving your number.' },
      { q: 'How does data completeness affect collections?', a: 'Missing fields produce claims that are rejected, held for review, or denied on first pass. MGMA estimates the average cost to rework a claim at $25.20. But the bigger cost is the delay: every rework cycle adds 15-30 days to your payment timeline.' },
      { q: 'Should I track DSO by payer or as a single number?', a: 'By payer \u2014 always. A blended DSO across all payers tells you almost nothing actionable. Medicare, commercial payers, Medicaid, and workers\' comp have fundamentally different payment timelines and denial rates.' },
      { q: 'How often should I review AR aging?', a: 'Weekly for the dashboard view (age-adjusted). Monthly for the full decomposition (payer-level, distribution analysis). Quarterly for the strategic review (trend comparison, data completeness correlation, payer mix shifts).' }
    ]
  },
  'marketing-spend-defending-not-growing-book': {
    file: '/content/blogs/marketing-spend-defending-not-growing-book.md',
    title: 'Is Your Marketing Working? The 10-Minute Cash Flow Test Every Owner Can Run',
    date: '2026-04-21',
    author: 'Gerrit Disbergen, EA',
    excerpt: 'A SE Florida imaging center ran marketing at 14% of revenue while claim volume fell 74% over two years. The spend was defending a shrinking book, not growing it. Here\'s the two-line test any owner can run on their own QuickBooks data in 10 minutes.',
    categories: ['Cash Flow'],
    readTime: '9 min read',
    featuredImage: '/images/blog/marketing-spend-defending-not-growing-book.jpg',
    faqs: [
      { q: 'How do I know if my marketing is working?', a: 'Plot marketing dollars and unit volume side by side for the last 24 months. If marketing is rising and unit volume is flat or falling, your spend is defending the book, not growing it. If both are rising together, you are buying growth and the investment is working. The test takes 10 minutes with data already in QuickBooks and your practice management or point-of-sale system.' },
      { q: 'What is a healthy marketing spend benchmark for a medical practice?', a: 'Healthy marketing spend for a multi-specialty medical or diagnostic imaging practice runs 3-5% of revenue, per MGMA and industry association data. Concierge and direct-pay practices can run higher (6-10%) because they carry more of the patient acquisition cost directly. If you are above 7% and unit volume is not rising, investigate what the spend is actually buying.' },
      { q: 'Why is my marketing spend growing but revenue is not?', a: 'The most common cause is vendor inertia — contracts and campaigns that were approved two or three years ago continue to run on autopay while the business conditions that justified them have changed. The second most common cause is defensive spending aimed at retention rather than acquisition. Both are fixable, but neither is visible without a unit-volume overlay on the marketing line.' },
      { q: 'Can I just cut marketing to fix this?', a: 'Not entirely. Some portion of your marketing is maintaining existing customer relationships and referring-source relationships that produce recurring volume. Cutting to zero will eventually cost you those relationships. The right answer is to cut the portion that is not producing measurable volume and preserve the portion that does. The two-line test usually makes the distinction obvious.' },
      { q: 'How does AI help with this diagnosis?', a: 'AI joins financial data (from QuickBooks) with operational data (from your practice management, POS, or scheduling system) and runs the diagnostic automatically every month. A human CFO reviewing a P&L quarterly will miss the defense pattern for three to six months. AI catches it in the month it emerges, which turns a six-month problem into a 30-day decision.' }
    ]
  },
  'lop-cash-cycle-personal-injury-practice-ar': {
    file: '/content/blogs/lop-cash-cycle-personal-injury-practice-ar.md',
    title: 'Why PI-Heavy Medical Practices Carry 20+ Months of A/R — The LOP Cash Cycle Explained',
    date: '2026-04-21',
    author: 'Gerrit Disbergen, EA',
    excerpt: 'A multi-location SE Florida imaging group carries $6.17M of A/R against $2.85M of annual collections — about 26 months. That is not a collections failure. It is the arithmetic of a Letter-of-Protection-heavy payer mix. Here is exactly how the math works, why DSO is the wrong metric, and what lenders should know before underwriting medical A/R that includes LOP.',
    categories: ['Healthcare Finance'],
    readTime: '11 min read',
    featuredImage: '/images/blog/lop-cash-cycle-personal-injury-practice-ar.jpg',
    faqs: [
      { q: 'Why does my medical practice have so much A/R?', a: 'If your practice bills any meaningful share of PIP or LOP cases, you will carry more A/R than a commercial-only practice — because PIP cycles run 60-120 days and LOP cycles run 18-36 months. The headline A/R number and the DSO ratio are nearly meaningless without a per-payer breakdown. Pull A/R separately for commercial, PIP, LOP, and patient balances, then measure each one against its own expected cycle.' },
      { q: 'How long does a letter of protection take to pay?', a: 'The industry average is 18-36 months, measured from the date of service to the date of settlement distribution. Some cases settle faster (12-18 months for clean, high-damage cases with cooperative attorneys) and some take much longer (48+ months for contested liability or extended litigation). Individual practices can estimate their own LOP cycle by pulling closed-case data over the prior three years.' },
      { q: 'What is a realistic LOP realization rate?', a: 'Industry norms run 30-55% of billed charges at settlement distribution. Realization depends on case outcome, counterparty relationships, and the quality of the underlying medical documentation. A practice with a three-year history of closed LOP cases can compute its own empirical realization rate and apply it to the current LOP book to produce a credible cash expectation for the next 24-36 months.' },
      { q: 'How do banks underwrite medical A/R that includes LOP?', a: 'Conservative lenders exclude LOP entirely from the borrowing base. Most specialty medical A/R lenders will include LOP at a meaningfully reduced advance rate — often 20-40% versus 60-80% on commercial — provided the practice can produce realization history, aging distribution, and counterparty concentration data. Lenders who do not understand LOP tend to either refuse the business or mis-price the risk; the practices that secure the best terms present the data proactively.' },
      { q: 'Is a high A/R number always a problem?', a: 'No. It depends on the payer mix. A commercial-only practice with $6M of A/R against $3M of annual collections would be a crisis. A PI-heavy practice with the same ratios can be operating exactly as designed. The only way to tell the difference is to decompose A/R by payer and measure each cohort against its own expected cycle.' }
    ]
  }
};
