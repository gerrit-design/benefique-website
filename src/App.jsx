...
function Blog() {
  ...
  const posts = [
    ...
    { title: 'Concierge Medical Practice Startup Costs: Full 2026 Breakdown', excerpt: 'What does it really cost to launch a concierge medical practice? We break down startup costs from $75K to $200K \u2014 entity structure, staffing, technology, South Florida lease benchmarks, and the financial mistakes that cost physicians more than the buildout.', date: '2026-03-08', slug: 'cost-starting-concierge-medical-practice', published: true, category: 'Concierge Medicine', readTime: '22 min' },
    ...
    { title: '10 KPIs Every Healthcare Practice Should Track in Real Time', excerpt: 'Collection rates, AR aging, overhead ratio, DSO, cash runway — these 10 KPIs should update daily, not monthly. Includes benchmarks for dental, radiology, and physician practices.', date: '2026-03-05', slug: 'real-time-financial-dashboards-healthcare-practices', published: true, category: 'Healthcare Finance', readTime: '11 min' },
    ...
    { title: 'AI Cash Flow Forecasting: Predict Your Cash Position 30 Days Out', excerpt: 'AI analyzes your QuickBooks data to predict cash shortfalls 30-60 days before they hit. One analysis found $353K trapped in receivables — another revealed a $147K cash deficit hidden behind a profitable P&L.', date: '2026-03-14', slug: 'ai-cash-flow-forecasting-small-business', published: true, category: 'Cash Flow', readTime: '18 min' },
    { title: 'Reduce Your DSO in 30 Days: 5 Strategies That Won\'t Lose Clients', excerpt: 'The average small business has $84,000 in unpaid invoices. These 5 strategies cut collection time without damaging relationships — most see results within 30 days.', date: '2026-03-03', slug: 'improve-dso-without-sacrificing-relationships', published: true, category: 'Cash Flow', readTime: '10 min' },
    { title: 'Your Monthly P&L Is 3 Weeks Late — Here\'s What It Already Cost You', excerpt: 'Your monthly P&L arrives 3-4 weeks after the month ends. By then, you\'ve already made payroll, paid vendors, and committed to expenses on dead data. See what real-time cash visibility actually looks like.', date: '2026-03-03', slug: 'why-monthly-reports-too-late', published: true, category: 'Cash Flow', readTime: '10 min' },
