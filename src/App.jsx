...
function Blog() {
  const posts = [
    ...
    { title: '1099 vs. W-2 in Your Healthcare or Service Practice: The Classification Mistake That Could Cost You $50,000+', excerpt: 'The IRS and DOL are cracking down on worker misclassification in healthcare and professional services. Dental hygienists, associate physicians, therapists, IT contractors—if you\'re paying them on a 1099, you might owe back taxes, penalties, and benefits.', date: '2026-02-26', slug: '1099-vs-w2-worker-classification-healthcare-service-businesses-broward-county', published: true },
