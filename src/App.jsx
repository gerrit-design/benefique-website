...
function Blog() {
  ...
  const posts = [
    ...
    { title: 'Concierge Doctor 300-Patient Panel Income: The Real Math for 2026', excerpt: 'What does a 300-patient concierge panel actually pay in 2026? Real revenue, overhead, and take-home math: every dollar from $1.26M gross to $430K net, step by step.', date: '2026-04-08', slug: 'concierge-doctor-300-patient-panel-income', published: true, category: 'Concierge Medicine', readTime: '14 min' },
    ...
    { title: 'Cash Flow Waterfall Explained: How Money Actually Moves Through a Business', excerpt: 'The cash waterfall framework \u2014 operating cash, debt service, distributions, working capital \u2014 visualized with a real $5M imaging-center example that earned $1.07M EBITDA and lost $41K of bank balance.', date: '2026-03-18', slug: 'ai-cash-flow-waterfall-explained', published: true, category: 'Cash Flow', readTime: '12 min' },
