...
function Blog() {
  ...
  const posts = [
    ...
    { title: 'Concierge Doctor Income: 300 Patients = $430K Take-Home (2026)', excerpt: 'What does a 300-patient concierge panel actually pay in 2026? Real revenue, overhead, and take-home math: every dollar from $1.26M gross to $430K net, step by step.', date: '2026-04-08', slug: 'concierge-doctor-300-patient-panel-income', published: true, category: 'Concierge Medicine', readTime: '14 min' },
    ...
    { title: '$1.07M EBITDA, \u2013$41K Cash: The Cash Flow Waterfall Explained', excerpt: 'The cash waterfall framework \u2014 operating cash, debt service, distributions, working capital \u2014 visualized with a real $5M imaging-center example that earned $1.07M EBITDA and lost $41K of bank balance.', date: '2026-03-18', slug: 'ai-cash-flow-waterfall-explained', published: true, category: 'Cash Flow', readTime: '12 min' },
    ...
    { title: 'How Much Does It Cost to Start a Concierge Practice? $75K–$200K (2026)', excerpt: 'The cost to start a solo concierge medical practice in 2026 is $75K–$200K, with most Broward County physicians landing at $100K–$175K. Full breakdown: entity setup, buildout, EHR, marketing, $19,750/mo fixed costs, and the S-Corp election timing most consultants forget.', date: '2026-03-08', slug: 'cost-starting-concierge-medical-practice', published: true, category: 'Concierge Medicine', readTime: '22 min' },
