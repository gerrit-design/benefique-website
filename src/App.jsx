...
function Blog() {
  ...
  const posts = [
    { title: 'Your Practice Doesn\'t Have a Profit Problem \u2014 It Has a Volume Problem', excerpt: 'Most accountants tell you \'you lost money this month.\' We tell you \'you need 70 more patients to never lose money again.\' Here\'s the fixed-cost breakeven analysis that changes how you think about profitability.', date: '2026-03-21', slug: 'fixed-cost-breakeven-volume-problem', published: true, category: 'Cash Flow', readTime: '14 min' },
