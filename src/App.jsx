...
function Blog() {
  ...
  const posts = [
    ...
    { title: '$1.07M EBITDA, \u2013$41K Cash: The Cash Flow Waterfall Explained', excerpt: '$1.07M EBITDA, \u2013$41K cash. The waterfall shows exactly where every dollar went \u2014 operating cash, debt service, distributions, working capital. Real $5M imaging-center walkthrough, line by line.', date: '2026-03-18', slug: 'ai-cash-flow-waterfall-explained', published: true, category: 'Cash Flow', readTime: '12 min' },
