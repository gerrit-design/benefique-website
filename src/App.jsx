...
function Blog() {
  ...
  const posts = [
    ...
    { title: 'How to Start a Concierge Medical Practice: Step-by-Step (2026)', excerpt: 'From entity formation ($2K-$5K) and S-Corp election to building your first 200-patient panel \u2014 the financial roadmap for launching a concierge practice. Includes the corporate B2B play worth $50K-$200K/year that most physician consultants skip.', date: '2026-03-17', slug: 'how-to-start-concierge-medical-practice', published: true, category: 'Concierge Medicine', readTime: '24 min' },
