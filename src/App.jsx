...
function Blog() {
  const posts = [
    { title: '5 Ways to Improve Your DSO Without Sacrificing Relationships', excerpt: 'The average small business has $84,000 in unpaid invoices. Here are 5 proven strategies to collect faster without damaging client relationships -- from clear terms to smart segmentation.', date: '2026-03-10', slug: 'improve-dso-without-sacrificing-relationships', published: true },
