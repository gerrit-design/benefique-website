...
function Blog() {
  ...
  const posts = [
    { title: 'Three Pages Every Owner Should Read in Their CFO Report', excerpt: 'We deliver a 40-page CFO report every month and tell owners to read three pages. Here\'s which three — and why the other 37 are not for the person running the business.', date: '2026-05-27', slug: 'three-pages-the-owner-reads', published: true, category: 'Business Strategy', readTime: '7 min read' },
