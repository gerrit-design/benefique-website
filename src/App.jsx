...
function Blog() {
  ...
  const posts = [
    ...
    { title: 'Blended Gross Margin: When a 15% P&L Hides a 50% Business', excerpt: 'A $3M distribution business showed a 15% gross margin and looked distressed. We split it into internal and external divisions and found a healthy 50%+ external business sitting next to a subsidized 9% internal transfer operation. The owner had been trying to fix the wrong problem for two quarters.', date: '2026-04-14', slug: 'blended-pl-lying-multi-entity-business', published: true, category: 'Cash Flow', readTime: '10 min read' },
